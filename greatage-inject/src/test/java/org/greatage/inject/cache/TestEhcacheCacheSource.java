 ...
 * @since 1.0
 */
public class TestEhcacheCacheSource extends Assert {
	...
	public void setupCacheManager() {
		...
		cacheConfiguration.maxElementsInMemory(10);
		final Configuration configuration = new Configuration();
		configuration.defaultCache(cacheConfiguration);
		final CacheManager cacheManager = new CacheManager(configuration);
		cacheSource = new EhcacheCacheSource(cacheManager);
	}
