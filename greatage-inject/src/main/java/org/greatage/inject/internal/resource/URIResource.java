...
/**
 * This class represents {@link Resource} implementation that is based on URI. It also can be used as {@link
 * org.greatage.inject.services.ResourceProvider} implementation.
 *
...
public class URIResource extends AbstractResource {
	...
	/**
	 * Obtains root URI resource. This is helper method for simplified root URI resource resolution. Can be used only as
	 * {@link org.greatage.inject.services.ResourceProvider} service.
	 *
