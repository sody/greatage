...
/**
 * This class represents {@link Resource} implementation that is based on application classpath. It also can be used as
 * {@link org.greatage.inject.services.ResourceProvider} implementation.
 *
	...
	protected Resource create(final String location, final String name, final String type, final Locale locale) {
		if (location != null) {
			...
			final String realLocation =
					PathUtils.PATH_SEPARATOR.equals(location) ? null : location.replaceAll("^/", "");
