...
/**
 * This interface represents service for working with application hierarchical resources. It also provides functionality
...
public interface ResourceLocator {
	...
	/**
	 * Searches for application resources in defined location with specified include filter. If include patterns is empty,
	 * resources will not be filtered.
	 *
	...
	/**
	 * Searches for application resources in defined location with specified include and exclude filters. If include or
	 * exclude patterns is empty they will be ignored.
	 *
	 * @param path	 resource location, not {@code null}
