...
public interface ServiceContributor<T> {
	 ...
	 * configuration: {@link org.greatage.inject.Configuration}, {@link org.greatage.inject.OrderedConfiguration} and
	 * {@link org.greatage.inject.MappedConfiguration} and provides collection, list and map to service via {@link
	 * ServiceResources} respectively.
	 *
