...
public class TestMessagesSource extends Assert {
	...
	public Object[][] getMessagesData() {
		return new Object[][]{
				...
				{
						TestMessagesSource.class, LocaleUtils.ROOT_LOCALE,
						CollectionUtils.newMap("test", "Test", "class", "Class")
				},
				...
				{
						TestMessagesSource.class, new Locale("ru", "RU", "xxx"),
						CollectionUtils.newMap("test", "Тест", "class", "Класс")
				},
		};
	}
