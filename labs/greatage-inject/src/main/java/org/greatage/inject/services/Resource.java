...
public interface Resource {
	...
	/**
	 * Gets absolute resource path inside the application resource system. It is calculated as {@code
	...
	/**
	 * Gets the same resource in specified locale. If specified locale is {@code null} it will return resource in root
	 * locale.
	 *
	...
	/**
	 * Searches for child resources with specified include filter. If include patterns is empty, resources will not be
	 * filtered.
	 *
	...
	/**
	 * Searches for child resources with specified include and exclude filters. If include or exclude patterns is empty
	...
	/**
	 * Searches for the resource candidate in defined or other candidate locale. If resource in its locale doesn't exist it
	 * will try to find resource in other candidate locales, e.g. if resource doesn't exist in {@code en_US} locale it will
	 * try to find it with {@code en} locale and then without locale.
	 *
