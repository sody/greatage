...
package org.greatage.ioc.internal.i18n;
...
/**
 * This class represents default {@link org.greatage.ioc.services.MessagesSource} implementation that uses {@link ResourceLocator} service to
...
public class MessagesSourceImpl extends AbstractMessagesSource {
	...
	/**
	 * {@inheritDoc} It uses {@link org.greatage.ioc.services.ResourceLocator} service to locate message bundles, reads them in UTF-8 encoding and
