...
/**
 * This class represents module definition that is used to build {@link org.greatage.inject.ServiceLocator}. By default it
 * is configured by simple class with all needed methods that represent service build, configure, intercept and invoke
 * points. It is also may be annotated by {@link org.greatage.inject.annotations.Dependency} class to define children
 * modules.
 *
