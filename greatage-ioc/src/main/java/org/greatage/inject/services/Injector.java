...
public interface Injector {
	 ...
	 * {@link SymbolSource} (needs {@link org.greatage.inject.annotations.Symbol} annotation), injected services
	 * by id (needs {@link org.greatage.inject.annotations.Inject} annotation) or services by their interfaces by default.
	 *
