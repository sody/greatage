...
package org.greatage.inject.internal.i18n;
...
/**
 * This class represents default {@link org.greatage.inject.services.MessagesSource} implementation that uses {@link ResourceLocator} service to
...
public class MessagesSourceImpl extends AbstractMessagesSource {
	...
	/**
	 * {@inheritDoc} It uses {@link org.greatage.inject.services.ResourceLocator} service to locate message bundles, reads them in UTF-8 encoding and
