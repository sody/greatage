...
public class ServiceInterceptorImpl<T> implements ServiceInterceptor<T> {
	 ...
	 * interception. Interception method must have {@link org.greatage.inject.Interceptor} return type and be annotated
	 * with {@link org.greatage.inject.annotations.Intercept} annotation.
	 *
