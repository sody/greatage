...
/**
 * This class represents {@link org.greatage.inject.services.Scope} implementation that is used for services that have the same state inside one application
