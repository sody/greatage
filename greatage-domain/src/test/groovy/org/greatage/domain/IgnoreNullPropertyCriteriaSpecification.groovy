...
abstract class IgnoreNullPropertyCriteriaSpecification extends Specification {
    ...
    def "not equal criteria should filter entities to those that have property value not equal to specified or null"() {
        when:
        def actual = findIds(Company.class, criteria)
        then:
        actual == expected
    ...
    def "greater than criteria with null parameter should filter entities to those that have not null property value"() {
        when:
        def actual = findIds(Company.class, criteria)
        then:
        actual == expected
    ...
    def "greater or equal criteria with null parameter should not filter entities"() {
        when:
        def actual = findIds(Company.class, criteria)
        then:
        actual == expected
    ...
    def "less than criteria should filter entities to those that have property value less than specified or null"() {
        when:
        def actual = findIds(Company.class, criteria)
        then:
        actual == expected
    ...
    def "less or equal criteria should filter entities to those that have property value less or equal to specified or null"() {
        when:
        def actual = findIds(Company.class, criteria)
        then:
        actual == expected
    ...
    def "less or equal criteria with null parameter should filter entities to those that have property value equal to null"() {
        when:
        def actual = findIds(Company.class, criteria)
        then:
        actual == expected
    ...
    def "in criteria with null parameters should filter entities to those that have property value in specified set or null"() {
        when:
        def actual = findIds(Company.class, criteria)
        then:
        actual == expected
