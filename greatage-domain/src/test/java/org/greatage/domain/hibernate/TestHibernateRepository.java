...
public class TestHibernateRepository extends Assert {
	...
	void test_find(final Class<E> entityClass, final Criteria<PK, E> criteria, final int expectedCount) {
		final int actualCount = repository.count(entityClass, criteria);
